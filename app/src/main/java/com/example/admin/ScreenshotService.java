...
public class ScreenshotService extends Service {
   ...
   // private static final int PORT = 42380;
    ...
    //private static String SCREENSHOT_FOLDER = "/storage/emulated/0/";
    ...
    private boolean isNativeRunning() {
        try {
            ...
            sock.connect(new InetSocketAddress("192.168.1.100", 5555), 1000);	// short timeout
        }
        catch (Exception e) {
...
//		return false;
    ...
    private Screenshot retreiveRawScreenshot() throws Exception {
        try {
            ...
            Socket s = new Socket();
            s.connect(new InetSocketAddress("192.168.1.100", 5555), TIMEOUT);
